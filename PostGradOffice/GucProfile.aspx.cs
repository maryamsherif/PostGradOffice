...
{
    public partial class GucProfile : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (rdr.Read())
            {
                ...
                if (rdr.GetOrdinal("undergradID") != null)
                {
                    Label nu = new Label();
                    nu.Text = "<br />" + "undergradID is null!";
                    nu.ForeColor = Color.Red;
                ...
                else
                {
                    ...
                    Label uID = new Label();
                    uID.Text = "<br />"+"My undergrad ID is : " + undergradID.ToString();
                    form1.Controls.Add(uID);
                }
