...
{
    public partial class NonGuican : System.Web.UI.Page
    {
        ...
        protected void viewNonThesis_Click(object sender, EventArgs e)
        {
            Response.Redirect("ThesisInfo.aspx");
        }

        protected void nonProfile_Click(object sender, EventArgs e)
        {
